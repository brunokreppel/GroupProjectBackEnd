  ...
  <div class="row">
    <div class="col-lg-4 mt-4">
      <div class="position-relative text-center text-muted bg-body border border-dashed rounded-5">
        ...
        <p class="col-lg-8 mx-auto mb-4">
          Create a new course to offer valuable content to your students.
        </p>
        <div class="d-flex justify-content-center">
          <div class="btn-group" role="group" aria-label="Course actions">
            ...
            <a href="myCourses.php?id=<?php echo $_SESSION["TUTOR"]; ?>" class="btn btn-primary px-4 mb-5 mx-2 rounded">View My</a>
            <?php endif; ?>
    ...
    <div class="col-lg-4 mt-4">
      <div class="position-relative text-center text-muted bg-body border border-dashed rounded-5">
        ...
        <p class="col-lg-8 mx-auto mb-4">
          Develop a new subject to enhance the curriculum.
        </p>
        <div class="d-flex justify-content-center">
          <div class="btn-group" role="group" aria-label="Subject actions">
            <a href="../subject/createSubject.php" class="btn btn-primary px-4 mb-5 mx-2 rounded">Create</a>
            <a href="../subject/subjects.php" class="btn btn-primary px-4 mb-5 mx-2 rounded">View</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 mt-4">
      <div class="position-relative text-center text-muted bg-body border border-dashed rounded-5">
        ...
        <p class="col-lg-8 mx-auto mb-4">
          Establish a new university with a unique identity and vision.
        </p>
        <div class="d-flex justify-content-center">
          <div class="btn-group" role="group" aria-label="University actions">
            <a href="../university/createUniversity.php" class="btn btn-primary px-4 mb-5 mx-2 rounded">Create</a>
            <a href="../university/universities.php" class="btn btn-primary px-4 mb-5 mx-2 rounded">View</a>
          </div>
        </div>
      </div>
    </div>
